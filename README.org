...
lsp-ui
- This package contains all the higher level UI modules of lsp-mode https://emacs-lsp.github.io/lsp-ui/
#+BEGIN_SRC emacs-lisp
  (use-package lsp-ui
   :ensure
...
lsp-treemacs
- Integration between lsp-mode and treemacs https://github.com/emacs-lsp/lsp-treemacs
#+BEGIN_SRC emacs-lisp
...
lsp-ivy
- lsp-ivy integrates Ivy with lsp-mode to make it easy to search for things by name in your code https://github.com/emacs-lsp/lsp-ivy
  #+BEGIN_SRC emacs-lisp
    (use-package lsp-ivy
      :ensure t)
  #+END_SRC
