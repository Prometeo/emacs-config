...
(custom-set-variables
 ...
 '(package-selected-packages
   '(sly treemacs-magit magit golden-ratio importmagic pydoc auto-virtualenv ruff-format flymake-ruff backup-walker sqlite3 forge counsel-projectile kaolin-themes org-bullets k8s-mode nord-theme dracula-theme python-black gitignore-templates key-chord anzu ag emmet-mode web-mode haskell-mode pyvenv eglot multiple-cursors dockerfile-mode ansible yaml-mode toml-mode company-box company flycheck-inline flycheck treemacs projectile git-timemachine git-gutter hydra yasnippet avy highlight-indent-guides aggressive-indent expand-region hungry-delete hl-todo rainbow-delimiters which-key counsel terraform-mode doom-modeline doom-themes all-the-icons use-package)))
(custom-set-faces
